          ...
          <div className="container mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center lg:items-start justify-between">
            ...
            >
              ...
              <p className="text-lg mt-4 text-gray-700">
                Have any questions? Our team is here to assist you. Fill out the
            ...
            >
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full mt-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500">
